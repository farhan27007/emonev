...
<head>
  <meta charset="utf-8">
  <title>Daftar sub kegiatan - Emonev Dashboard</title>
        ...
        <main id="js-page-content" role="main" class="page-content">
          ...
          <div class="subheader">
            <h1 class="subheader-title">
              <i class='subheader-icon fal fa-file-alt'></i> Daftar sub kegiatan
            </h1>
          </div>
          <div class="row">
            <div class="col-lg-12">
              <div id="panel-4" class="panel">
                ...
                <div class="panel-container show">
                  <div class="panel-content">
                    ...
                    <p align="right">
                      <a href="tambah-sub-kegiatan.php" class="btn btn-success waves-effect waves-themed">
                    ...
                    <table id="dt-basic-example" class="table table-bordered table-hover table-striped w-100 dataTable dtr-inline collapsed">
                      ...
                      <tbody>
                        <tr>
                          ...
                          <td>Keterangan</td>
                          <td>
                            <a href="edit-sub-kegiatan.php" class="btn btn-info btn-icon waves-effect waves-themed">
