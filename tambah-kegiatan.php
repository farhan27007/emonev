    ...
    <head>
        <meta charset="utf-8">
        <title>Tambah kegiatan - Emonev Dashboard</title>
                    ...
                    <main id="js-page-content" role="main" class="page-content">
                        ...
                        <div class="subheader">
                            <h1 class="subheader-title">
                                <i class='subheader-icon fal fa-user-plus'></i> Tambah kegiatan
                            </h1>
                        </div>
                        <div class="row">
                          <div class="col-lg-12">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-6 col-md-6 mb-3 mt-3">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" placeholder="Masukkan Kode kegiatan...">
                                                </div>
                                            </div>
